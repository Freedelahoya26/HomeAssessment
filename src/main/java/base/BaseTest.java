...
public class BaseTest {
	...
	public void beforeTest() {
		...
		extentRep.setSystemInfo("Website", "WIKI");
		extentRep.setSystemInfo("browser", "Chrome");
		sparkReporter.config().setDocumentTitle("WIKI Automation Report");
		sparkReporter.config().setReportName("WIKI Automation by Dinesh");
